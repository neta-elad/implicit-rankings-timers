...
def dijsktra3state():
    ...
    function_sym = {"next": [Node, Node], "prev": [Node, Node], "a": [Node, Value]}
    ...
    def induction_axiom1(sym):
        ...
        return Implies(
            ...
            Exists(
                Z,
                And(
                    sym["a"](Z) != sym["a"](sym["bot"]),
                    ForAll(
                        Y,
                        Implies(
                            sym["a"](Y) != sym["a"](sym["bot"]), sym["leq_node"](Z, Y)
                        ),
                    ),
                ),
            ),
    ...
    def induction_axiom2(sym):
        ...
        return Implies(
            ...
            Exists(
                Z,
                And(
                    sym["a"](Z) == plus2mod3(sym["a"](sym["bot"])),
                    ForAll(
                        Y,
                        Implies(
                            sym["a"](Y) == plus2mod3(sym["a"](sym["bot"])),
                            sym["leq_node"](Z, Y),
                        ),
                    ),
                ),
    ...
    def induction_axiom3(sym):
        ...
        return Implies(
            Exists(
                Y, And(Y != sym["bot"], sym["a"](Y) != plus1mod3(sym["a"](sym["bot"])))
            ),
            Exists(
                Z,
                And(
                    Z != sym["bot"],
                    sym["a"](Z) != plus1mod3(sym["a"](sym["bot"])),
                    ForAll(
                        Y,
                        Implies(
                            And(
                                Y != sym["bot"],
                                sym["a"](Y) != plus1mod3(sym["a"](sym["bot"])),
                            ),
                            sym["leq_node"](Z, Y),
                        ),
                    ),
    ...
    def stability_prev_top_axiom(sym):
        return Implies(
            ...
            ForAll(X, Implies(X != sym["top"], sym["a"](X) == sym["a"](sym["bot"]))),
        )
