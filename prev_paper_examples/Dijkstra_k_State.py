...
def dijsktrakstate():
    ...
    relation_sym = {"leq_node": [Node, Node], "leq_value": [Value, Value]}
    function_sym = {
        "a": [Node, Value],
        "prev": [Node, Node],
    }
    ...
    axiom_leq_node = lambda sym: ForAll(
        [X, Y, Z],
        And(
            Implies(
                And(sym["leq_node"](X, Y), sym["leq_node"](Y, Z)), sym["leq_node"](X, Z)
            ),
    ...
    axiom_leq_value = lambda sym: ForAll(
        [S, T, R],
        And(
            Implies(
                And(sym["leq_value"](S, R), sym["leq_value"](R, T)),
                sym["leq_value"](S, T),
            ),
    ...
    axiom_well_founded = lambda sym: Implies(
        ...
        Exists(
            ...
            And(
                ...
                ForAll(
                    Y,
                    Implies(sym["a"](Y) != sym["a"](sym["bot"]), sym["leq_node"](X, Y)),
                ),
            ),
        ),
    )
    ...
    tr_wakeup = lambda sym1, sym2, param: And(
        ...
        If(
            ...
            If(
                ...
                And(
                    succ_value(
                        sym1, sym1["a"](sym1["prev"](param["n"])), sym2["a"](param["n"])
                    ),
                    ForAll(X, Implies(X != param["n"], sym2["a"](X) == sym1["a"](X))),
                ),
                And(
    ...
    order_bot_first = lambda sym, param1, param2: And(
        sym["leq_node"](param1["n"], param2["n"]), param1["n"] != param2["n"]
    )
    order_bot_last = lambda sym, param1, param2: And(
        param1["n"] != param2["n"],
        Or(
            And(sym["leq_node"](param1["n"], param2["n"]), param1["n"] != sym["bot"]),
            param2["n"] == sym["bot"],
        ),
    )
    ...
    p2 = lambda sym: True
    q2 = lambda sym: ForAll(
        X, Implies(X != sym["bot"], sym["a"](X) != sym["a"](sym["bot"]))
    )
    ...
    p3 = q2
    q3 = lambda sym: And(
        priv(sym, sym["bot"]), ForAll(X, Implies(X != sym["bot"], Not(priv(sym, X))))
    )
    ...
    phi3 = lambda sym: And(
        ...
        ForAll(
            [X, Y],
            Implies(
                And(sym["leq_node"](X, Y), sym["a"](Y) == sym["a"](sym["bot"])),
                sym["a"](X) == sym["a"](sym["bot"]),
            ),
        ),
    )
    ...
    phi5 = lambda sym: And(rho5(sym), p5(sym), Not(q5(sym)))
    ...
    order_h_last = lambda sym, param1, param2: And(
        Or(
            param2["n"] == sym["node_h"],
            And(
                sym["leq_node"](param1["n"], param2["n"]),
                sym["leq_node"](sym["node_h"], param1["n"]),
                param1["n"] != sym["node_h"],
            ),
            And(
                sym["leq_node"](param1["n"], param2["n"]),
                sym["leq_node"](param2["n"], sym["node_h"]),
            ),
            And(
                sym["leq_node"](sym["node_h"], param1["n"]),
                param1["n"] != sym["node_h"],
    ...
    print("checking P5")
    proof5.check_proof(ts5)  # takes about a min
