    ...
    while i < len(lines):
        ...
        if line.startswith("invariant") or line.startswith("conjecture"):
            ...
            while j < len(lines):
                ...
                if (not next_line.startswith('invariant') and 
                    not next_line.startswith('conjecture') and
                    (next_line.startswith('(') or 
                     ...
                     next_line.startswith('~') or
                     next_line.startswith(')') or
                     next_line.startswith('forall') or
                     next_line.startswith('exists') or
                     next_line.startswith('globally') or
                     next_line.startswith('eventually') or
                     '->' in next_line or
                     '<->' in next_line or
                     '&' in next_line or
                     '|' in next_line or
